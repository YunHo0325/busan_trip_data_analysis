...
<body>
	<div id="content">
		...
		<section>
			<div id="main">
				<form action="noticeAdminSearchProc.jsp">
				...
				<table id="user_table" class="table">
					...
					<tr>
						...
						<td id="element_subject">
							<a href="noticeAdminDetail.jsp?num=<%=notice.getnNum() %>">
								<%=notice.getSubject() %>
							</a>
						</td>
...
%>
				...
				<div id="write">
					<input type=button class="btn btn-dark" value="글작성" onClick="location.href='noticeRegForm.jsp'"> 
				</div>
			</div>
		</section>
